...
import 'package:micro_finance/screens/add_expense/blocs/create_categorybloc/create_category_bloc.dart';
import 'package:micro_finance/screens/add_expense/blocs/get_categories_bloc/get_categories_bloc.dart';
import 'package:micro_finance/screens/add_expense/views/add_expense.dart';
import 'package:micro_finance/screens/home/blocs/get_expenses_bloc/get_expenses_bloc.dart';
import 'package:micro_finance/screens/home/views/main_screen.dart';
    ...
    builder: (context, state) {
      if (state is GetExpensesSuccess) {
        ...
        return const Scaffold(
          body: Center(
            child: Text('Failed to load expenses. Please try again.'),
          ),
        );
      } else {
        return const Scaffold(
